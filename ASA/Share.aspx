<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Share.aspx.cs" Inherits="ASA.Share" %>
...
<html class="no-js">
	...
	<body>
		...
		<a href="#" class="fh5co-offcanvass-close js-fh5co-offcanvass-close">Profile <i class="icon-cross"></i> </a>
		<h1 class="fh5co-logo"><a class="navbar-brand" href="#" style="color:white">TELOTAR</a></h1>
		<ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 " style="background-color:black">
					<a class="navbar-brand"  href="index.html" style="color:white">TELOTAR</a>
                     <a href="#" class="fh5co-menu-btn js-fh5co-menu-btn"style="color:white">Profile<i class="icon-menu"></i></a>
